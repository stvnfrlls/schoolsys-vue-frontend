<template>
  <div class="d-flex min-vh-100 student-layout">
    <!-- Sidebar -->
    <nav class="sidebar d-flex flex-column p-3">
      ...
      <ul class="nav nav-pills flex-column gap-1">
        <li class="nav-item">
          <RouterLink to="/student/dashboard" class="sidebar-link">
            <i class="bi bi-person-circle me-2"></i>My Profile
          </RouterLink>
        </li>
        <li class="nav-item">
          <RouterLink to="/student/schedule" class="sidebar-link">
            <i class="bi bi-calendar-week me-2"></i>My Schedule
          </RouterLink>
        </li>
        <li class="nav-item">
          <RouterLink to="/student/grades" class="sidebar-link">
            <i class="bi bi-graph-up me-2"></i>My Grades
          </RouterLink>
        </li>
        <li class="nav-item">
          <RouterLink to="/student/attendance" class="sidebar-link">
            <i class="bi bi-check-circle me-2"></i>My Attendance
          </RouterLink>
        </li>
        <li class="nav-item">
          <RouterLink to="/student/assignment" class="sidebar-link">
      ...
      <div class="sidebar-footer mt-auto pt-3">
        <div class="sidebar-user-name">{{ studentName }}</div>
